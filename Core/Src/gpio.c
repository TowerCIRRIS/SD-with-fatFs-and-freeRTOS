...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOF, OUT_IMU1_CS_Pin|OUT_IMU2_CS_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(OUT_OLED_DC_GPIO_Port, OUT_OLED_DC_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PFPin PFPin */
  GPIO_InitStruct.Pin = OUT_IMU1_CS_Pin|OUT_IMU2_CS_Pin;
  ...
  /*Configure GPIO pin : PtPin */
  GPIO_InitStruct.Pin = OUT_OLED_DC_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(OUT_OLED_DC_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : PtPin */
  GPIO_InitStruct.Pin = IN_BUTTON_2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(IN_BUTTON_2_GPIO_Port, &GPIO_InitStruct);
